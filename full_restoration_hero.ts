...
// The target section starts from mainArticle guard and goes to the start of Ad Space
...
if (startIndex !== -1 && endIndex !== -1) {
              ...
              {mainArticle && (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary-navy/90 via-transparent to-transparent flex flex-col justify-end p-8 md:p-10 pb-16 md:pb-20">
                    {/* Urgent Badge - Repositioned to left/top for visibility on mobile */}
    ...
    const newContent = content.substring(0, startIndex) + fullRestoredHero + content.substring(endIndex);
    fs.writeFileSync(filePath, newContent);
    console.log('Successfully restored full high-end hero section');
} else {
