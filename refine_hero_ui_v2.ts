...
if (startIndex !== -1 && endIndex !== -1) {
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary-navy/90 via-transparent to-transparent flex flex-col justify-end p-8 md:p-10 pb-16 md:pb-20">
                    ...
                    <div className="flex flex-col items-start gap-3 w-full max-w-4xl">
                      {/* Urgent Badge - Positioned as per screenshot blue square (Right above title) */}
                      <motion.div
                        initial={{ opacity: 0, x: 20 }}
                        animate={{ opacity: 1, x: 0 }}
                        className="flex justify-end w-full mb-1 pr-12 md:pr-20"
                      >
                  ...
                  {/* Hero Navigation Buttons - Shifted SLIGHTLY UPWARDS (top-[40\%] instead of 1/2) */}
    ...
    console.log('Successfully refined hero UI (badge & arrows)');
} else {
