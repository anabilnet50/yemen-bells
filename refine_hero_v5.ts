...
if (startIndex !== -1 && endIndex !== -1) {
              ...
              {mainArticle && (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary-navy/90 via-transparent to-transparent flex flex-col justify-end p-8 md:p-10 pb-16 md:pb-20">
                    {/* Content Stack - RTL Aligned (Right Side) */}
                    <div className="flex flex-col items-end gap-3 w-full max-w-4xl mx-auto text-right">
                      {/* Urgent Badge - Increased Size & Specific Alignment */}
                      <motion.div
    ...
    console.log('Successfully refined hero typography (larger badge & title below)');
} else {
